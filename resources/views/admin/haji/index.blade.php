...
<div class="content">
    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Daftar List Haji</h3>
        </div>
        <div class="block-content block-content-full">
            <!-- DataTables functionality is initialized with .js-dataTable-full-pagination class in js/pages/be_tables_datatables.min.js which was auto compiled from _es6/pages/be_tables_datatables.js -->
            <button type="button" id="addHaji" data-toggle="modal" data-target="#modalHaji" class="btn btn-outline-primary mb-4"><i class="fa fa-plus"></i> Tambah Paket Haji</button>
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-vcenter js-dataTable-full-pagination tableHaji">
                    <thead>
                        <tr>
                            ...
                            <th class="d-none d-sm-table-cell text-center" style="width: 25%;">dp</th>
...
{{-- Modal Add Haji --}}
<div class="modal fade" id="modalHaji" tabindex="-1" role="dialog" aria-labelledby="modalHaji" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Haji</h3>
                ...
                <div class="block-content">
                    <form class="js-validation-bootstrap" action="" name="frm_haji" id="frm_haji" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama">Nama</label>
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Paket Haji">
                                </div>
                                <div class="form-group">
                                    <label for="overtime">DP</label>
                                    <input type="text" class="form-control input-currency" type-currency="IDR" id="dp" name="dp" placeholder="Rp">
                                </div>
                                <div class="form-group">
...
@endsection
@push('scripts')
@include('admin.haji.javascript')
@include('admin.haji.validate')
@endpush